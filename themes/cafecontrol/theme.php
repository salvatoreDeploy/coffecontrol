...
<head>
    ...
    <title>CoffeControl - Gerencie suas contas com um bom café</title>
    ...
    <div class="container content">
        <section class="main_footer_content">
            ...
            <article class="main_footer_content_item social">
                <h2>Social:</h2>
                <a class="icon-facebook" href="http://wwww.facebook.com/<?= CONF_SOCIAL_FACEBOOK_PAGE; ?>" title="CoffeControl no Facebook">/CoffeControl</a>
                <a class="icon-instagram" href="http://wwww.instagram.com/<?= CONF_SOCIAL_INSTAGRAM_PAGE; ?>" title="CoffeControl no Instagram">@CoffeControl</a>
                <a class="icon-youtube" href="http://wwww.youtube.com/<?= CONF_SOCIAL_YOUTUBE_PAGE; ?>" title="CoffeControl no YouTube">/CoffeControl</a>
            </article>
        </section>
    </div>
</footer>
